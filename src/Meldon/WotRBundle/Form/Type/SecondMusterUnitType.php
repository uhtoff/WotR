...
class SecondMusterUnitType extends WotRType {
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $game = $this->game;
        $data = $game->getCurrentAction()->getData();
        $choices = $game->getUnitsToRecruit($game->getLocations()->get($data['secondLocation']->getID()),false);
        $builder

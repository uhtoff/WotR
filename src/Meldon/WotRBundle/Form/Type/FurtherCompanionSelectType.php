...
class FurtherCompanionSelectType extends AbstractType {
    private $game;
    ...
    {
        $builder
            ->add('complete', new ReturnType(), array('label' => 'Finish moving Companions'))
    ...
    {
        return 'FurtherCompanionSelectType';
    }
}